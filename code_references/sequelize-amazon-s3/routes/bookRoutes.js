...
router.post('/book/create', [bookValidator.image_upload, bookValidator.create], BookController.create)
router.put('/book/update', [bookValidator.image_upload, bookValidator.update], BookController.update)
